...
WITH tmp AS (
	SELECT is_manager FROM tenant_accounts WHERE tenant_id = $1 AND tenant_accounts.account_id = $2
)
INSERT INTO tenant_accounts (tenant_id, account_id, is_manager) SELECT $1, $3, $4 FROM tmp WHERE tmp.is_manager = true;
